...
Wow. So many amazing plugins that some how seem to make the bot even more boring than it was when it was completely useless. Fear not, for there are a variety of optional plugins designed to strip the boring and replace it with disco balls and techno.
...
* AutoRejoin - Rejoin on a channel on KICK or on connection automatically
