...
The framework that mod_spox provides is what allows it to quickly transition from an old sack of moldy potatoes to an old sack of moldy potatoes on fire. Luckly, mod_spox comes with a bunch of prepackaged plugins, so you too can have an IRC bot of your very own!
